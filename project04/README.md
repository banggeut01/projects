  ...
  * [01_layout.css](01_layout.css)
        ...
        4. **(필수)** Footer
            ...
            1. **필수 사항**            
                              ...
                              * 높이는 **50px 이상**, 너비는 **브라우저 전체 영역**입니다.
                                 * 왼쪽에는 **본인의 이름 혹은 닉네임**, 오른쪽에는 **헤더로 올라가는 링크**로 구성됩니다. Footer는 padding이 좌우로 3rem 
    ...
    ​                 
     ...
     5. **(필수)** Font 설정
        ...
        ```html
        <link href="https://fonts.googleapis.com/css?family=Gothic+A1|Nanum+Gothic|Nanum+Myeongjo|Noto+Sans+KR&display=swap" rel="stylesheet">
        ```
